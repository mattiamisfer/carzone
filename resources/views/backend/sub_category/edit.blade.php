    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="card border-top border-0 border-4 border-danger">
                ...
                @endif --}}
                    <form class="row g-3" method="POST" action="{{ route('admin.sub.category.update',$subcat->id)}}" enctype="multipart/form-data">
                        @method('PUT')
                     @csrf
                        ...
                        <div class="col-12">
                           ...
                           name="input_{{$item['name']}}" aria-label="Default select example">
                            ...
                            <option   {{$category->id == $item['value'] ? 'selected' : 'ee'}}  value="{{ $category->id }}">{{ $category->name }}</option>
                            @endforeach
